...
| **H4-mac** | ⬜ (v0.4.24) | **macOS**: cùng mục nav — nav macOS khớp cứng storyboard (enum==index==vị-trí), làm riêng cho chắc: enum thêm `Journal`, nav dựng theo thứ-tự-hiển-thị, pane embed danh sách note. |
