...
/**
 * [MINDFUL] Listener "tai nghe lén": được gọi mỗi khi một TỪ vừa hoàn chỉnh
 * (tại word-boundary, ngay trước khi engine reset). Dùng cho lớp đọc cảm xúc.
 * Mặc định nullptr = tắt, engine chạy y như cũ.
 */
extern void (*vOnWordCommitted)(const wstring& word);
