...
| **F8 · Nâng cao (round sau)** | Vuốt phím + macro; sync theme opt-in | CN-12, CN-13 | Laban swipe/macro; engine `Macro.cpp` |
...
| **R2** Bàn phím giống Laban + lớp cảm xúc nhẹ | Lõi đầy đủ + sóng + chuông + cài đặt | F1(mở rộng), F4, F5, F6 |
| **R3** Cá nhân hóa + nhật ký | Theme trung tính + nhật ký + soi lại | F6(mở rộng), F7 |
| **R4+** Nâng cao & phát hành | Vuốt phím/macro, sync opt-in, ký/notarize/TestFlight | F8 |
