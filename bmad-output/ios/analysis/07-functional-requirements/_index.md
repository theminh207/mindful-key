...
| FR-A15 | Vuốt phím + gõ tắt (macro) | CN-12 | F8 | Won't (đợt này) | mới | ⬜ hoãn |
...
### FR-A15 — Vuốt phím + macro · Won't (đợt này) · ←CN-12
**Statement:** (Hoãn) Hệ thống *shall* hỗ trợ vuốt phím nhập chữ + gõ tắt macro.
**AC:** — ghi để không rơi; đưa lại khi mở round nâng cao.
