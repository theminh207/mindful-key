...
- **Nút "Tải cho macOS"** → `releases/latest/download/MindfulKey.dmg` — bấm phát tải luôn, không thả
  ...
  `MindfulKey.dmg` bên cạnh bản có version — xem `docs/tasks/RELEASE.md`. Đổi repo thì sửa link trong `index.html`.
...
Chi tiết: `docs/tasks/REPO-TOPOLOGY.md §6` · `docs/tasks/ROADMAP.md` Giai đoạn 1.
