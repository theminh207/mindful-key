...
map<UINT, LPCTSTR> menuData = {
	...
	{POPUP_ABOUT_MINDFULKEY, _T("Giới thiệu Mindful Keyboard")},
	{POPUP_MINDFULKEY_EXIT, _T("Thoát")},
};
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam) {
	...
	case WM_CLOSE:
		// Dọn y hệt nút "Thoát" ở khay (AppDelegate::onMindfulKeyExit: gỡ hook, xoá icon khay, PostQuit)
...
// [MINDFUL] Nhờ luồng cửa sổ kiểm "MindfulKey gốc đang chạy?" rồi cảnh báo nếu có — CHỈ đặt tin nhắn,
